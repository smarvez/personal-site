      ...
      return (
        <div id="about-epro">
          ...
          <div className="epro-blurb">
            ...
            <p className="project-blurb">By following flu-related tweets on Twitter, FluTracker allows users to visualize the proliferation of the flu by day, up to the past week. Additionally, users can either search the map via scrolling or by geolocation to view how many people are sick within a given area.</p>
